...
public class GameRunner {
	...
	public static void main(String[] args) {
		...
		// choice.  Here I choose the TicTacToe game.

		
		GameRunner gameRunner = new GameRunner(new TicTacToe());
		gameRunner.playGame();
	}
	...
	/**
	 * One the runner has been initialized with a TicTacToe (or HangmanGame or ...) 
	 * (an implementation of the interface) we can run against the interface.
	 */
	void playGame() {
		try {
